...
public final class Keyboard extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_5_26(); }
  public static Keyboard getRootAsKeyboard(ByteBuffer _bb) { return getRootAsKeyboard(_bb, new Keyboard()); }
  public static Keyboard getRootAsKeyboard(ByteBuffer _bb, Keyboard obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createKeyboard(FlatBufferBuilder builder,
      int typeOffset,
      int keyOffset) {
    builder.startTable(2);
    Keyboard.addKey(builder, keyOffset);
    Keyboard.addType(builder, typeOffset);
    return Keyboard.endKeyboard(builder);
  }

  public static void startKeyboard(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static int endKeyboard(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Keyboard get(int j) { return get(new Keyboard(), j); }
    public Keyboard get(Keyboard obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
