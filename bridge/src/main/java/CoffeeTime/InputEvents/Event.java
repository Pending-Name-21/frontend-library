...
public final class Event extends Table {
  ...
  public CoffeeTime.InputEvents.Keyboard keyboard() { return keyboard(new CoffeeTime.InputEvents.Keyboard()); }
  public CoffeeTime.InputEvents.Keyboard keyboard(CoffeeTime.InputEvents.Keyboard obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public CoffeeTime.InputEvents.Mouse mouse() { return mouse(new CoffeeTime.InputEvents.Mouse()); }
  public CoffeeTime.InputEvents.Mouse mouse(CoffeeTime.InputEvents.Mouse obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static void addKeyboard(FlatBufferBuilder builder, int keyboardOffset) { builder.addOffset(0, keyboardOffset, 0); }
  public static void addMouse(FlatBufferBuilder builder, int mouseOffset) { builder.addOffset(1, mouseOffset, 0); }
